...
// content background
const contentBackgroundColor = Colors.white;
const contentBackgroundColorDark = Color(0xff1C1E21);
...
// app bar text color
const appBarTextColor = appBarIconsColor;
const appBarTextColorDark = appBarIconsColorDark;
